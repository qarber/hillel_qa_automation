...
// ще як варіант намагався заюзати тернарний (Number.isInteger(result)) ? console.log('true') : console.log('false');
// при умові якщо просто ділити num1 / num2 БЕЗ остачі
// але в такому кейсі чомусь виводить undefined крім true і false (нерозібрався чому) 
}
...
// ваш код
let decresedValue = value + 2;
if (value <= 10) {
    console.log(value);
}

if (decresedValue <= 10) {
    recursiveAddition(decresedValue);
    }
    else {
        console.log();
